...
import platform, os, datetime, warnings
...
def obtener_fecha(id):
	...
	if type(id) is not str:
		raise TypeError("Error al pasar de id a fecha")
...
def obtener_cod_fecha(fecha):
	...
	if type(fecha) is not datetime.datetime:
		raise TypeError("obtener_cod_fecha() sólo admite datetime como parámetro")

	if int(fecha.month) < 10:
...
def obtener_cod_hora(fecha):
	...
	if type(fecha) is not datetime.datetime:
		raise TypeError("obtener_cod_hora() sólo admite datetime como parámetro")
...
def obtener_id(fecha):
	...
	if type(fecha) is not datetime.datetime:
		raise TypeError("obtener_id acepta sólo datetime como parámetros.")
